...
(
  ...
  PRIMARY KEY (Dept_ID),
  CONSTRAINT DeptLoc FOREIGN KEY (Dept_Location_ID) REFERENCES PARK(Location_ID)
);
...
(
  ...
  CONSTRAINT EmpDept FOREIGN KEY (Employee_Dept_ID) REFERENCES DEPARTMENT(Dept_ID)
);
...
(
  ...
  PRIMARY KEY (Name),
  CONSTRAINT SectLoc FOREIGN KEY (Section_Location_ID) REFERENCES PARK(Location_ID)
);
...
(
  ...
  CONSTRAINT AttrSect FOREIGN KEY (Attr_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  PRIMARY KEY (FB_ID),
  CONSTRAINT FBSect FOREIGN KEY (FB_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  PRIMARY KEY (Show_ID),
  CONSTRAINT LESect FOREIGN KEY (LE_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  PRIMARY KEY (Exp_ID),
  CONSTRAINT CESect FOREIGN KEY (CE_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  PRIMARY KEY (Location_ID),
  CONSTRAINT FASect FOREIGN KEY (FA_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  CONSTRAINT PHSect FOREIGN KEY (PH_Park_Section) REFERENCES SECTION(Name),
  CONSTRAINT PHAttrID FOREIGN KEY (PH_Attr_Event_ID) REFERENCES ATTRACTION(Attraction_ID), 
  CONSTRAINT PHCEID FOREIGN KEY (PH_CE_Event_ID) REFERENCES CHARACTER_EXPERIENCE(Exp_Id)
);
...
(
  ...
  CONSTRAINT MerchSect FOREIGN KEY (Merch_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  CONSTRAINT TicketLoc FOREIGN KEY (Ticket_Location_ID) REFERENCES PARK(Location_ID)
);
...
(
  ...
  CONSTRAINT HotelLoc FOREIGN KEY (Hotel_Park_ID) REFERENCES PARK(Location_ID) 
);
...
(
  ...
  CONSTRAINT TranSect FOREIGN KEY (Trans_Park_Section) REFERENCES SECTION(Name)
);
...
(
  ...
  CONSTRAINT MerchStore FOREIGN KEY (Sell_Merch_Store_ID) REFERENCES MERCHANDISE(Store_ID),
  CONSTRAINT MerchID FOREIGN KEY (Sell_Merch_Item_ID) REFERENCES ITEM(Item_ID)
);
